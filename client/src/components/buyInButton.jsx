    ...
    render() {
        ...
        return (
            <div className={buyInInfoClassName} id="buyin-info">
                <div className="row">
                    <input className="u-max-full-width" name="playerName" type="text" value={this.state.playerName} 
                        onChange={this.handleInputChange} placeholder="name" min="2" max="10" 
                        id="new-playerName" readOnly="true" />
                </div>
                <div className="row">
                    <input className="u-max-full-width" name="stackSize" type="number" value={this.state.stackSize} 
                        onChange={this.handleInputChange} placeholder="stack size" min="1" 
                        id="new-stack" readOnly="true" />
                </div>
